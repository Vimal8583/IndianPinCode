...
import com.example.androidfirebaseassessment.databinding.ItemLayoutBinding
...
class SetDataAdapter(var context: Context, var addresslist:MutableList<Address>,
                     var mRef: DatabaseReference,
                     var displayData: Boolean = false,
                     private val onItemClick: (Int) -> Unit): RecyclerView.Adapter<SetDataAdapter.MyViewHolder>() {
    class MyViewHolder(var binding:ItemLayoutBinding):RecyclerView.ViewHolder(binding.root)
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SetDataAdapter.MyViewHolder {
        var binding= ItemLayoutBinding.inflate(LayoutInflater.from(context),parent, false)
        return MyViewHolder(binding)
    }

    override fun onBindViewHolder(holder: SetDataAdapter.MyViewHolder, position: Int) {
    ...
    private fun updateLikeStatusInFirebase(location: Address) {
    ...
    fun updateList(locationList: List<Address>, displayData: Boolean = true) {
    ...
    private fun shareLocation(location: Address) {
